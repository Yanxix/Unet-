...
def parse_args():
    ...
    parser.add_argument('--optimizer', default='Adam',
                        ...
                        help='loss: ' +
                            ' | '.join(['Adam', 'SGD']) +
                            ' (default: Adam)')
    parser.add_argument('--lr', '--learning-rate', default=0.0048, type=float,
...
def main():
    ...
    # Data loading code
    img_paths = glob(r'D:\deeplearning\BrainTumorSegmentation-main\data\trainImage\*')
    mask_paths = glob(r'D:\deeplearning\BrainTumorSegmentation-main\data\trainMask\*')
    ...
    # 加载预训练模型，移除 'module.' 前缀
    #state_dict = torch.load('models/batchsize/model.pth')
...
# python train.py --arch UNet_3Plus
